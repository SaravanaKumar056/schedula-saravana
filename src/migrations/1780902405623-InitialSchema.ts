...
export class InitialSchema1780902405623 implements MigrationInterface {
    name = 'InitialSchema1780902405623'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "doctor_profile" ("id" SERIAL NOT NULL, "fullName" character varying NOT NULL, "specialization" character varying NOT NULL, "experience" integer NOT NULL, "qualification" character varying NOT NULL, "consultationFee" numeric(10,2) NOT NULL, "availability" character varying NOT NULL, "profileDetails" text, "userId" integer, CONSTRAINT "REL_f3a33e785199cebab93b11d123" UNIQUE ("userId"), CONSTRAINT "PK_644ccb5654dfad6ae661c5684aa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "patient_profile" ("id" SERIAL NOT NULL, "fullName" character varying NOT NULL, "age" integer NOT NULL, "gender" character varying NOT NULL, "contactDetails" character varying NOT NULL, "basicHealthInformation" text, "userId" integer, CONSTRAINT "REL_1de3767e7d351c683f4f8923ae" UNIQUE ("userId"), CONSTRAINT "PK_17f75e7aa12a2d0b0c3924b2e81" PRIMARY KEY ("id"))`);
